...
- [ ] Étape 6 — validation flotte réelle (rebuild XCFramework + redéploiement 5 appareils) — EN COURS, XCFramework en cross-compile de fond ; NAS + iPad/iPhone/AppleTV injoignables à cette date (NAS "Host is down", devices Offline dans Xcode) — déploiement bloqué tant qu'ils ne reviennent pas en ligne
