//! Cryptographic key handling for the ToM protocol stack.
...
/// The identifier for an endpoint in the network.
///
/// Each endpoint has a unique identifier created as a cryptographic key.  This can be
...
impl SecretKey {
    ...
    /// let _key = tom_base::SecretKey::generate(&mut rand::rng());
    /// ```
