//! A fully-fledged tom-relay server over HTTP or HTTPS.
//!
//! This module provides an API to run a full fledged tom-relay server.  It is primarily
//! used by the `tom-relay` binary in this crate.  It can be used to run a relay server in
