            ...
            tokio::spawn(async move {
                ...
                let body = format!(
                    concat!(
                        ...
                        "\"connexions_pool\":{connexions_pool},",
                        "\"clients_relais_actifs\":{clients_relais_actifs},",
                        "\"relais_accepts_total\":{relais_accepts_total},",
                        "\"conns_quic_live\":{conns_quic_live},",
                        "\"handshakes_accepted\":{handshakes_accepted},",
                    ...
                    relayeurs = snap.relayeurs_connus,
                    peers_known = snap.peers_known,
                    connexions_pool = peers.len(),
                    clients_relais_actifs = snap.clients_relais_actifs,
                    relais_accepts_total = snap.relais_accepts_total,
                    conns_quic_live = snap.conns_quic_live,
                    handshakes_accepted = snap.handshakes_accepted,
